...
static TABLE: &[(&str, &str, &str, &str, &str)] = &[
    ...
    ("group.none.genre", "Unknown genre", "Unbekanntes Genre", "Genre inconnu", "Genre sconosciuto"),
    ...
    ("action.download_all", "Download all", "Alle herunterladen", "Tout télécharger", "Scarica tutto"),
    ("ctx.download", "Download", "Herunterladen", "Télécharger", "Scarica"),
    ("ctx.open", "Open", "Öffnen", "Ouvrir", "Apri"),
    ("ctx.download_all", "Download all", "Alle herunterladen", "Tout télécharger", "Scarica tutto"),
    ("ctx.delete", "Delete", "Löschen", "Supprimer", "Elimina"),
    ("ctx.delete_series", "Delete series", "Reihe löschen", "Supprimer la série", "Elimina serie"),
    ("dl.failed", "Failed", "Fehlgeschlagen", "Échoué", "Fallito"),
    ("dl.in_progress", "Downloading…", "Lädt…", "Téléchargement…", "Download…"),
    ("dl.progress", "Downloading %d / %d", "Lade %d / %d", "Téléchargement %d / %d", "Download %d / %d"),
    ...
    ("dl.tap_close", "Tap to close", "Tippen zum Schließen", "Touchez pour fermer", "Tocca per chiudere"),
    ...
    ("dl.remaining", "%d remaining", "%d verbleibend", "%d restant", "%d rimanenti"),
];
...
pub(crate) fn resolve(
    ...
    if let Some(e) = env_lang.filter(|s| !s.is_empty()).and_then(|s| lang_prefix(s)) {
        return e;
    }
    if let Some(c) = lang_pref.filter(|s| !s.is_empty()).and_then(normalize_language) {
        return c;
    }
    "en"
}
