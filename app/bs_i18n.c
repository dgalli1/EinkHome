...
const I18n g_i18n[] = {
    ...
    {"dl.tap_dismiss",
     "Tap to dismiss \u2014 downloads continue",
     "Tippen zum Schlie\u00dfen \u2014 Downloads laufen weiter",
     "Touchez pour fermer \u2014 le t\u00e9l\u00e9chargement continue",
     "Tocca per chiudere \u2014 i download continuano"},
    {"dl.tap_close",
     "Tap to close",
